    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            if ($user->country_code) {
                try {
                    $packageName = 'Country' . $user->country_code;
                    $countryManager = app(\App\Classes\CountryPackageManager::class);
                    ...
                    if ($package) {
                        ...
                        if (is_dir($packagePath)) {
                            ...
                            $countryManager->loadActive();
                        }
                    }
                } catch (\Exception $e) {
                    \Log::warning('Country package activation failed during registration: ' . $e->getMessage());
                }
            }
