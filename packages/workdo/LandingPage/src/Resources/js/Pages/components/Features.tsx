...
export default function Features({ settings, countryFeatures }: FeaturesProps) {
    ...
    const features = countryFeatures?.length > 0 ? countryFeatures : (sectionData.features?.length > 0 ? sectionData.features : defaultFeatures);
