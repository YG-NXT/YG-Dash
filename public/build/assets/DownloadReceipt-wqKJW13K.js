import{a as x}from"./html2pdf-DPj86RUe.js";import{a as u,p as w,f as i}from"./helpers-BRfeGxMF.js";import"./vendor-CcMVubkO.js";import"./app-DzWA8JdN.js";import"./ui-44uVE41x.js";const _=async(t,a)=>{var d;const v=`
        <div class="receipt">
            <div class="header">
    ...
    `,o=document.createElement("div");o.innerHTML=v,document.body.appendChild(o);const y={margin:.1,filename:`receipt-${t.pos_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"mm",format:[80,297],orientation:"portrait"}};try{await x().set(y).from(o).save()}catch(n){console.error("PDF generation failed:",n)}finally{document.body.removeChild(o)}};export{_ as downloadReceiptPDF};
