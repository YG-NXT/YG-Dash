import { LayoutGrid, Users, Building2, Settings, Shield, Image, Package, CreditCard, FileText, Ticket, Mail, Bell, Headphones, Clock, Globe } from 'lucide-react';
...
export const getSuperAdminMenu = (t: (key: string) => string): NavItem[] => [
    ...
    {
        title: t('Country Packages'),
        href: route('country-packages.index'),
        icon: Globe,
        permission: 'manage-country-packages',
        order: 3010,
    },
    {
        title: t('Settings'),
